...
use crate::primitives::zkp2::reenc::{ReEncZKP, ReEncZKPChallenge, ReEncZKPCommit, ReEncZKPContext, ReEncZKPProof, ReEncZKPPublicData, ReEncZKPResponse, ReEncZKPWitness};
...
pub struct OrTwoReEncZKPChallenge<G> where G: Group{
    chal1: <G as Group>::Scalar,
    chal2: <G as Group>::Scalar,
}
// The real challenge is the sum of the two internal challenges
pub type OrTwoReEncZKPSumChallenges<G> = <G as Group>::Scalar;
...
impl<G> OrTwoReEncZKP<G> where G: Group
{
    ...
    fn respond(&self, state: OrTwoReEncZKPState<G>, challenge: OrTwoReEncZKPSumChallenges<G>)
            -> (OrTwoReEncZKPResponse<G>, OrTwoReEncZKPChallenge<G>) {
        ...
        if state.side == 1 {
            ...
            let chal = OrTwoReEncZKPChallenge {
                chal1: chal1,
                chal2: st2.challenge,
            };
    ...
    fn verify(&self, commit: &OrTwoReEncZKPCommit<G>, sum_challenges: &OrTwoReEncZKPSumChallenges<G>, challenge: &OrTwoReEncZKPChallenge<G>, response: &OrTwoReEncZKPResponse<G>)
              -> bool {
